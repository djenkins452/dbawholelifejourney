...
description: "Migrated source command `close`"
---
...
Verify ALL documentation was updated for every change this session, fix any gaps, then provide a session summary. This is a safety net — the docs should already be done per "On Task Completion" in AGENTS.md, but /close catches anything missed.
...
- Pushed to main
- No uncommitted work left (ignore .Codex/settings.local.json and Xcode state files)
...
Ask user before making significant changes to AGENTS.md.
