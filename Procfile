web: python manage.py migrate --noinput && python manage.py load_sports_data && python manage.py seed_game_events && python manage.py collectstatic --noinput && gunicorn config.wsgi --preload --log-file - --workers 4 --timeout 30
