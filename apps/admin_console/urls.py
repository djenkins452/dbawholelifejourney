...
urlpatterns = [
    ...
    path("api/claude/dupe-trace/", __import__("apps.admin_console.glassbox_dupe_trace", fromlist=["DupeTraceView"]).DupeTraceView.as_view(), name="api_claude_dupe_trace"),  # TEMPORARY glass-box — remove after trace
