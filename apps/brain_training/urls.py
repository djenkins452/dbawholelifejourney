...
urlpatterns = [
    ...
    path('api/session/<int:session_id>/pause/', views.api_session_pause, name='api_session_pause'),
    path('api/session/<int:session_id>/resume/', views.api_session_resume, name='api_session_resume'),
    path('api/sessions/in-progress/', views.api_in_progress_sessions, name='api_in_progress_sessions'),
