...
COACHING_STYLE_TEMPLATES = {
    'default': {
        ...
        # Phase 4: Cross-domain proactive templates
        'faith_reading_gap': "Day {day} of {plan} is waiting. You're {progress}% through.",
        'faith_prayer_reminder': "You have {count} prayer requests with daily reminders.",
        'faith_streak_break': "Your scripture reading streak ended at {streak} days. Want to start fresh?",
        'finance_budget_alert': "You've used {percent}% of your {category} budget with {days_left} days left this month.",
        'finance_goal_milestone': "Your '{goal}' goal is at ${current} of ${target} ({percent}%).",
        'finance_goal_stalling': "Your '{goal}' goal hasn't had progress in {days} days. Target date: {target_date}.",
        'relationship_drift': "It's been {days} days since you connected with {person}. They're in your {tier} circle.",
        'goal_deadline': "Your goal '{goal}' is due in {days} days.",
        'goal_stalling': "Your goal '{goal}' hasn't had a milestone update in {days} days.",
        'habit_streak_break': "Your '{habit}' streak ended at {streak} days. Ready to restart?",
        ...
        'routine_pre_nudge_soon': "{item_name} is coming up soon.",
        'routine_pre_nudge_imminent': "{item_name} starts in a few minutes.",
    ...
    'southern_belle': {
        ...
        'faith_reading_gap': "Day {day} of {plan} is waitin', dear. You're {progress}% through.",
        'faith_prayer_reminder': "You've got {count} prayer requests with daily reminders, hon.",
        'faith_streak_break': "Your scripture readin' streak ended at {streak} days. Want to get back on track, sweetie?",
        'finance_budget_alert': "Sugar, you've used {percent}% of your {category} budget with {days_left} days to go.",
        'finance_goal_milestone': "Your '{goal}' is at ${current} of ${target} ({percent}%). Comin' along!",
        'finance_goal_stalling': "Your '{goal}' hasn't moved in {days} days, hon. Target date: {target_date}.",
        'relationship_drift': "It's been {days} days since you talked to {person}, dear. They're in your {tier} circle.",
        'goal_deadline': "Your goal '{goal}' is due in {days} days, hon.",
        'goal_stalling': "Your goal '{goal}' hasn't had a milestone update in {days} days, dear.",
        'habit_streak_break': "Your '{habit}' streak ended at {streak} days. Ready to pick it back up?",
        ...
        'routine_pre_nudge_soon': "{item_name} is comin' up soon, dear.",
        'routine_pre_nudge_imminent': "{item_name} starts in just a bit, hon.",
    ...
    'new_yorker': {
        ...
        'faith_reading_gap': "Day {day} of {plan}. {progress}% done.",
        'faith_prayer_reminder': "{count} prayer requests have daily reminders.",
        'faith_streak_break': "Scripture streak ended at {streak} days. Restarting?",
        'finance_budget_alert': "{percent}% of {category} budget used. {days_left} days left.",
        'finance_goal_milestone': "'{goal}': ${current} of ${target} ({percent}%).",
        'finance_goal_stalling': "'{goal}' — no progress in {days} days. Due: {target_date}.",
        'relationship_drift': "{days} days since {person}. {tier} circle. Worth reaching out.",
        'goal_deadline': "'{goal}' due in {days} days.",
        'goal_stalling': "'{goal}' — no milestone update in {days} days.",
        'habit_streak_break': "'{habit}' streak broke at {streak} days. Restarting?",
        ...
        'routine_pre_nudge_soon': "{item_name} — coming up.",
        'routine_pre_nudge_imminent': "{item_name} — any second now.",
    ...
    'california': {
        ...
        'faith_reading_gap': "Day {day} of {plan} is waiting. You're {progress}% through.",
        'faith_prayer_reminder': "You have {count} prayer requests with daily reminders.",
        'faith_streak_break': "Scripture reading streak ended at {streak} days. Wanna start fresh?",
        'finance_budget_alert': "You've used {percent}% of your {category} budget with {days_left} days left.",
        'finance_goal_milestone': "Your '{goal}' is at ${current} of ${target} ({percent}%).",
        'finance_goal_stalling': "Your '{goal}' hasn't moved in {days} days. Target date: {target_date}.",
        'relationship_drift': "It's been {days} days since you connected with {person}. They're in your {tier} circle.",
        'goal_deadline': "Your goal '{goal}' is due in {days} days.",
        'goal_stalling': "Your goal '{goal}' hasn't had a milestone update in {days} days.",
        'habit_streak_break': "Your '{habit}' streak ended at {streak} days. Wanna restart?",
        ...
        'routine_pre_nudge_soon': "Heads up — {item_name} is coming up soon.",
        'routine_pre_nudge_imminent': "Almost time for {item_name}.",
