...
class CalendarMutationService:
    ...
    def create(
        ...
        # NOTE: manual Calendar Events stay calendar-native (source_type=none).
        # We deliberately no longer manufacture a backing Task here — under the
        # Calendar Projection Law the Calendar owns its native events and never
        # creates truth in another domain (Tasks own tasks).
        # See docs/WLJ_CALENDAR_PROJECTION_ARCHITECTURE.md.
