...
class SavedVerseModelTest(TestCase):
    ...
    def test_saved_verse_belongs_to_user(self):
        ...
        verse = SavedVerse.objects.create(
            ...
            text='Bring the whole tithe into the storehouse...',
            translation='ESV',
            book_name='Malachi',
            book_order=39,
            chapter=3,
            verse_start=10,
            themes=['giving', 'blessing']
        )
    ...
    def test_saved_verse_str(self):
        ...
        verse = SavedVerse.objects.create(
            user=self.user,
            reference='Jonah 2:9',
            text='But I, with shouts of grateful praise...',
            translation='NIV',
            book_name='Jonah',
            book_order=32,
            chapter=2,
        ...
        self.assertIn('Jonah 2:9', str(verse))
...
class SavedVerseDataIsolationTest(TestCase):
    ...
    def setUp(self):
        ...
        # NOTE: Use obscure references to avoid conflicts with example code/comments
        self.verse_a = SavedVerse.objects.create(
            user=self.user_a,
            reference='Obadiah 1:4',
            text='Though you soar like the eagle...',
            translation='ESV',
            book_name='Obadiah',
            book_order=31,
            chapter=1,
    ...
    def test_user_a_only_sees_own_saved_verses(self):
        ...
        self.assertContains(response, 'Obadiah 1:4')
        # Should NOT see User B's verse
        self.assertNotContains(response, 'Nahum 1:7')
    ...
    def test_user_b_only_sees_own_saved_verses(self):
        ...
        # Should see their own verse
        self.assertContains(response, 'Nahum 1:7')
        # Should NOT see User A's verse
        self.assertNotContains(response, 'Obadiah 1:4')
...
class SavedVerseFilterTest(TestCase):
    ...
    def setUp(self):
        ...
        SavedVerse.objects.create(
            ...
            text='For the earth will be filled with the knowledge...',
            translation='ESV',
            book_name='Habakkuk',
            book_order=35,
            chapter=2,
            verse_start=14,
            themes=['glory', 'promise']
        )
        SavedVerse.objects.create(
            user=self.user,
            reference='Habakkuk 3:19',
            text='The Sovereign Lord is my strength...',
            translation='ESV',
            book_name='Habakkuk',
            book_order=35,
            chapter=3,
            verse_start=19,
            themes=['strength', 'promise']
        )
        SavedVerse.objects.create(
            user=self.user,
            reference='Zephaniah 3:17',
            text='The Lord your God is with you...',
            translation='NIV',
            book_name='Zephaniah',
            book_order=36,
            chapter=3,
    ...
    def test_filter_by_book(self):
        ...
        response = self.client.get(reverse('faith:scripture_list'), {'book': 'Habakkuk'})

        self.assertContains(response, 'Habakkuk 2:14')
        self.assertContains(response, 'Habakkuk 3:19')
        self.assertNotContains(response, 'Zephaniah 3:17')

    def test_filter_by_theme(self):
        """Filter saved verses by theme."""
        response = self.client.get(reverse('faith:scripture_list'), {'theme': 'promise'})
    ...
    def test_available_themes_from_user_verses_only(self):
        ...
        self.assertIn('glory', content)
        self.assertIn('promise', content)
        self.assertIn('joy', content)
        self.assertIn('comfort', content)
...
class SavedVerseEditTest(TestCase):
    ...
    def setUp(self):
        ...
        self.verse = SavedVerse.objects.create(
            user=self.user,
            reference='Amos 5:24',
            text='But let justice roll on like a river...',
            translation='ESV',
            book_name='Amos',
            book_order=30,
            chapter=5,
    ...
    def test_edit_page_loads(self):
        ...
        self.assertContains(response, 'Amos 5:24')
    ...
    def test_edit_verse_updates_notes(self):
        ...
        response = self.client.post(
            reverse('faith:saved_verse_edit', kwargs={'pk': self.verse.pk}),
            {
                ...
                'text': 'But let justice roll on like a river...',
                'translation': 'ESV',
                'themes_text': 'justice, righteousness',
                'notes': 'Updated notes'
            }
        )
    ...
    def test_edit_verse_updates_themes(self):
        ...
        self.client.post(
            reverse('faith:saved_verse_edit', kwargs={'pk': self.verse.pk}),
            {
                ...
                'text': 'But let justice roll on like a river...',
                'translation': 'ESV',
                'themes_text': 'justice, righteousness, prophecy',
                'notes': ''
            }
        )
        self.verse.refresh_from_db()
        self.assertEqual(self.verse.themes, ['justice', 'righteousness', 'prophecy'])
    ...
    def test_cannot_edit_other_users_verse(self):
        ...
        other_verse = SavedVerse.objects.create(
            user=other_user,
            reference='Joel 2:28',
            text='And afterward, I will pour out my Spirit...',
            translation='NIV',
            book_name='Joel',
            book_order=29,
            chapter=2,
...
class SavedVerseDeleteTest(TestCase):
    ...
    def test_deleted_verse_not_shown_in_list(self):
        ...
        response = self.client.get(reverse('faith:scripture_list'))
        self.assertNotContains(response, 'Micah 6:8')
    ...
    def test_cannot_delete_other_users_verse(self):
        ...
        other_verse = SavedVerse.objects.create(
            ...
            text='The glory of this present house will be greater...',
            translation='NIV',
            book_name='Haggai',
            book_order=37,
            chapter=2,
...
class MemoryVerseTest(TestCase):
    ...
    def test_only_one_memory_verse_at_a_time(self):
        ...
        verse2 = SavedVerse.objects.create(
            user=self.user,
            reference='Hosea 6:6',
            text='For I desire mercy, not sacrifice...',
            translation='ESV',
            book_name='Hosea',
            book_order=28,
            chapter=6,
    ...
    def test_cannot_toggle_other_users_verse(self):
        ...
        other_verse = SavedVerse.objects.create(
            ...
            text='Not by might nor by power, but by my Spirit...',
            translation='NIV',
            book_name='Zechariah',
            book_order=38,
            chapter=4,
...
class MemoryVerseOnDashboardTest(TestCase):
    ...
    def test_scripture_list_no_memory_verse_when_faith_disabled(self):
        ...
        SavedVerse.objects.create(
            ...
            text='Because of the Lords great love we are not consumed...',
            translation='ESV',
