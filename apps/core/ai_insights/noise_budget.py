...
# Public aliases for test access
MAX_INSIGHTS_PER_DAY = _DEFAULT_MAX_INSIGHTS_PER_DAY
MAX_INSIGHTS_PER_6H_WINDOW = _DEFAULT_MAX_INSIGHTS_PER_6H_WINDOW
MAX_CROSS_DOMAIN_PER_DAY = _DEFAULT_MAX_CROSS_DOMAIN_PER_DAY
