...
def health_ingest(request):
    ...
    # Generic device→server diagnostic channel: persist whatever the client reported
    # (a lightweight, reusable channel — no longer steps-specific).
