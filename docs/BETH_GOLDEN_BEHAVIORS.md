...
> **Baseline commit:** `35c27f58` (main) — *"persistent thinking placeholder across navigation."*
> **Suggested baseline tag:** `beth-stable-v1` (see `BETH_ROLLBACK_AND_RECOVERY.md`).
