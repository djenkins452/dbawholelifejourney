...
# NOTE (2026-07-10): TestTrivialCompletion + the feasibility/move_later 'trivial
# rescue' triage behavior it covered were RETIRED when the check-in became a pure
# consumer of the single Execution Decision Authority (current_action). The check-in
# no longer computes its own time-boxing/ordering — that would be a second decision
# engine (see apps/core/tests/test_execution_decision_authority_contract.py). If
# deadline-aware time-boxing is wanted, it belongs IN the authority, not the renderer.
