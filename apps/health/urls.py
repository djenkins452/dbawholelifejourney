...
legacy_redirects = [
    ...
    path("medicine/", RedirectView.as_view(pattern_name="health:medicine_home", permanent=True)),
    path("medicine/<path:rest>", RedirectView.as_view(url="/health/physical/medicine/%(rest)s", permanent=True)),
...
urlpatterns = [
    ...
    # Medicine
    path("physical/medicine/", views.MedicineHomeView.as_view(), name="medicine_home"),
    path("physical/medicine/list/", views.MedicineListView.as_view(), name="medicine_list"),
    path("physical/medicine/add/", views.MedicineCreateView.as_view(), name="medicine_create"),
    path("physical/medicine/<int:pk>/", views.MedicineDetailView.as_view(), name="medicine_detail"),
    path("physical/medicine/<int:pk>/edit/", views.MedicineUpdateView.as_view(), name="medicine_update"),
    path("physical/medicine/<int:pk>/delete/", views.MedicineDeleteView.as_view(), name="medicine_delete"),
    path("physical/medicine/<int:pk>/pause/", views.MedicinePauseView.as_view(), name="medicine_pause"),
    path("physical/medicine/<int:pk>/resume/", views.MedicineResumeView.as_view(), name="medicine_resume"),
    path("physical/medicine/<int:pk>/complete/", views.MedicineCompleteView.as_view(), name="medicine_complete"),
    path("physical/medicine/<int:pk>/schedules/", views.MedicineSchedulesView.as_view(), name="medicine_schedules"),
    path("physical/medicine/<int:medicine_pk>/schedules/<int:schedule_pk>/delete/", views.MedicineScheduleDeleteView.as_view(), name="medicine_schedule_delete"),
    path("physical/medicine/<int:medicine_pk>/schedules/<int:schedule_pk>/activate/", views.MedicineScheduleActivateView.as_view(), name="medicine_schedule_activate"),
    path("physical/medicine/<int:pk>/supply/", views.MedicineUpdateSupplyView.as_view(), name="medicine_update_supply"),
    path("physical/medicine/<int:pk>/take/<int:schedule_pk>/", views.MedicineTakeView.as_view(), name="medicine_take"),
    path("physical/medicine/<int:pk>/skip/<int:schedule_pk>/", views.MedicineSkipView.as_view(), name="medicine_skip"),
    path("physical/medicine/<int:pk>/undo/<int:schedule_pk>/", views.MedicineUndoView.as_view(), name="medicine_undo"),
    path("physical/medicine/bulk-take/<str:time_of_day>/", views.MedicineBulkTakeView.as_view(), name="medicine_bulk_take"),
    path("physical/medicine/bulk-skip/<str:time_of_day>/", views.MedicineBulkSkipView.as_view(), name="medicine_bulk_skip"),
    path("physical/medicine/prn/", views.PRNLogView.as_view(), name="medicine_prn_log"),
    path("physical/medicine/history/", views.MedicineHistoryView.as_view(), name="medicine_history"),
    path("physical/medicine/<int:pk>/history-take/<int:schedule_pk>/", views.MedicineHistoryTakeView.as_view(), name="medicine_history_take"),
    path("physical/medicine/<int:pk>/history-skip/<int:schedule_pk>/", views.MedicineHistorySkipView.as_view(), name="medicine_history_skip"),
    path("physical/medicine/log/<int:pk>/edit/", views.MedicineLogEditView.as_view(), name="medicine_log_edit"),
    path("physical/medicine/adherence/", views.MedicineAdherenceView.as_view(), name="medicine_adherence"),
    path("physical/medicine/quick-look/", views.MedicineQuickLookView.as_view(), name="medicine_quick_look"),
    path("physical/medicine/<int:pk>/request-refill/", views.MedicineRequestRefillView.as_view(), name="medicine_request_refill"),
    path("physical/medicine/<int:pk>/clear-refill/", views.MedicineClearRefillView.as_view(), name="medicine_clear_refill"),
