...
def format_cos_system_injection(context, user_message=None):
    ...
    lines.append(
        ...
        "\n"
        "'What have I completed today?' → List ONLY completed items. No assumptions, "
        "no future items. Use checkmarks. End with count.\n"
        "\n"
        "'What have I NOT completed?' → Separate into:\n"
        "  - Due now / overdue (past scheduled time)\n"
        "  - Upcoming later (scheduled time still ahead)\n"
        "  Do NOT mix these categories.\n"
        "\n"
        "'How am I doing today?' → Blend: today truth + meaningful progress + "
        "one improvement area + one next move.\n"
        "  'You\\'ve completed prayer and you\\'re off to a solid start. "
        "Finishing Bible reading next will strengthen your faith routine, "
        "and getting your workout in will keep moving your health goal forward.'\n"
        "\n"
        "'What should I be doing right now?' → ONE clear directive based on "
        "current focus. Not a schedule recital.\n"
        "  'Start your Bible reading now.' or\n"
        "  'You don\\'t have anything overdue. Your next priority is your "
        "workout at 6:15.'\n"
        "\n"
        ...
        "— make sure to log it when you\\'re done.'\n"
        "  - User in faith/bible area: 'Looks like you\\'re in your reading. "
