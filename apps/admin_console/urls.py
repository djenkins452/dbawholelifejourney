...
urlpatterns = [
    ...
    # TEMPORARY — P1 rehearsal/backfill/rollback. Remove with the view in one commit.
    path("api/claude/finance-p1/", views.FinanceP1OperatorAPIView.as_view(), name="api_claude_finance_p1"),
