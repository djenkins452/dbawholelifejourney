...
class CycleOptInPageView(HelpContextMixin, LoginRequiredMixin, TemplateView):
    """
    ...
    help_context_id = "HEALTH_CYCLE_OPTIN"
...
class CycleDashboardView(HelpContextMixin, LoginRequiredMixin, TemplateView):
    ...
    help_context_id = "HEALTH_CYCLE_DASHBOARD"
...
class CycleDataManagementView(HelpContextMixin, LoginRequiredMixin, CycleTrackingEnabledMixin, TemplateView):
    """
    ...
    help_context_id = "HEALTH_CYCLE_DATA"
