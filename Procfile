web: python manage.py migrate --noinput && python manage.py load_initial_data --reset help_topics && python manage.py load_initial_data && python manage.py recalculate_task_priorities && python manage.py collectstatic --noinput && gunicorn config.wsgi --preload --log-file -
# Updated: 2026-01-04 - TEMPORARY: --reset help_topics to load new glucose help. REMOVE after deploy!
