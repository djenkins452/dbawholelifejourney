        ...
        if weather_data:
            ...
            return {
                ...
                "data": {
                    ...
                    # Deep-link to Weather.com for this location (hourly/daily/
                    # radar/extended). Generated by WeatherData.to_dict(); the
                    # header pill is an <a> that opens it in a new tab.
                    "weather_url": raw.get("weather_url") or "https://weather.com",
                },
                "message": None,
            }
    except Exception:
