...
RESPONSE_COMPLETION_REMINDER = (
    ...
    "data' after a single retrieval when more deterministic truth WLJ holds is one tool call "
    "away — gather the truth the objective needs (additional history windows, record detail, "
    "progression) first, and reserve 'insufficient' for a genuine absence of WLJ truth. "
