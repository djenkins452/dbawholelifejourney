    ...
    "finance": {
        ...
        "entities": {
            "transaction": ("A single financial transaction — its date, amount (income or "
                            ...
                            "purchases and for fees/interest charged, and absent for "
                            "income, refunds, credit-card payments, mortgage and loan "
                            "payments, transfers, savings allocations, cash withdrawals "
                            "and anything WLJ could not classify), merchant/description, "
                            "category, and account. Search by merchant with the "
                            "`contains` filter; scope by period/on_date. FOR 'LARGEST / "
                            "BIGGEST / TOP N' SPENDING QUESTIONS use the RANKING subject "
                            "`transaction_by_spend` via get_ranked_entity — a plain list "
                            "is capped and ordered by DATE, so it can silently omit the "
                            "largest one. NOTE: paying a credit card or a loan is NOT "
                            "spending and will never appear in this ranking — the "
                            "purchases a card payment settles were already counted when "
                            "they were made. If the person seems to mean money LEAVING "
                            "their account rather than what their living cost, that is a "
                            "different question: read the `monthly_views` packet, which "
                            "carries liquid cash movement and credit-card payments "
                            "separately."),
            "recurring": ("Recurring commitments — subscriptions, bills, loan payments, "
                          "transfers and recurring income. Carries BOTH what the person "
                          "has CONFIRMED and what WLJ has merely DETECTED: read `status` "
                          "(`confirmed` / `candidate` / `ignored`) and "
                          "`plan.counted_in_committed_forecast` before saying anything. "
                          "A candidate is a proposal — say so ('WLJ found these likely "
                          "subscriptions; your forecast excludes them until you confirm "
                          "them'), never present one as an established commitment. "
                          "`standing.confidence` and `standing.evidence` say how sure WLJ "
                          "is and why (how many occurrences, over what span, how far "
                          "apart, what range of amounts). Filter with "
                          "`review_state=confirmed|candidate|ignored`. WLJ never promotes "
                          "a candidate on its own and neither may you — surface it and "
                          "ask."),
            "monthly_views": ("THE authority for \"how did this month go\" — three "
                              "questions kept apart, each with its full line-by-line "
                              "walk. (1) spending_result: income less what their living "
                              "cost, a surplus or a deficit. (2) liquid_cash: whether "
                              "the money available in their chequing/savings went up or "
                              "down. (3) card_activity: whether credit-card debt grew or "
                              "shrank, activity-based because WLJ stores no statement "
                              "balance. THEY ARE ALLOWED TO DISAGREE — they answer "
                              "different questions, and a wide gap between the first two "
                              "means a lot went on a card. NEVER describe one as "
                              "another, and never call any of them \"cash flow\". Also "
                              "carries the superseded whole-account figure, only to "
                              "explain a number the person may remember seeing."),
            "money_bridge": ("Six views of the same period and how they relate — what it "
                             "cost, paid towards debt, money moved, what left the "
