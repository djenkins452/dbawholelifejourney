...
urlpatterns = [
    ...
    path("api/claude/import-trace/", __import__("apps.admin_console.glassbox_import_trace", fromlist=["ImportTraceView"]).ImportTraceView.as_view(), name="api_claude_import_trace"),  # TEMPORARY glass-box — remove after trace
