...
CONTEXT IS ALREADY LOADED - DO NOT READ AGENTS.md
...
```bash
curl -s -H "X-Codex-API-Key: $WLJ_CLAUDE_API_KEY" "https://wholelifejourney.com/admin-console/api/Codex/ready-tasks/?limit=10&auto_start=true"
```
