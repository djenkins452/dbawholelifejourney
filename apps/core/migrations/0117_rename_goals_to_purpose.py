"""
Data migration: rename module="goals" → "purpose" in Insight and Prediction records.
...
def rename_goals_to_purpose(apps, schema_editor):
    """Rename module='goals' → 'purpose' in Insight and Prediction records."""
    ...
    if updated_insights or updated_predictions:
        print(
