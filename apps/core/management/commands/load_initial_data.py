...
Tasks are sorted by priority (ascending) then creation date.""",
    ...
    def _reset_workout_display_fixtures(self, DataLoadConfig, force=False, verbosity=1):
        """
        One-time reset to reload release_notes for HealthKit workout display.
        - release_notes PK 76 (Apple Watch Workout Display)
        """
        reset_tracker_name = 'reset_workout_display_2026_02_21'
        ...
        try:
            try:
                ...
                config.reset()
                if verbosity >= 1:
                    self.stdout.write('  Reset release_notes loader for workout display')
            except DataLoadConfig.DoesNotExist:
                pass
            ...
            self._mark_loader_complete(
                ...
                'command',
                'One-time reset to reload release_notes PK 76'
            )
