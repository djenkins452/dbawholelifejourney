...
urlpatterns = [
    ...
    path("import/<int:pk>/clarify/dismiss/", views.ClarificationDismissView.as_view(), name="clarify_dismiss"),
    path("import/<int:pk>/clarify/restore/", views.ClarificationRestoreView.as_view(), name="clarify_restore"),
    path("import/<int:pk>/clarify/<str:kind>/<str:ref>/", views.ClarificationResolveView.as_view(), name="import_clarify"),
    path("import/<int:pk>/refresh/", views.ImportRefreshView.as_view(), name="import_refresh"),
    path("import/<int:pk>/refresh/apply/", views.ImportRefreshApplyView.as_view(), name="import_refresh_apply"),
    ...
    path("places/review-locations/", views.LocationReviewView.as_view(), name="location_review"),
    path("places/<int:pk>/review-location/", views.LocationReviewApplyView.as_view(), name="location_review_apply"),
