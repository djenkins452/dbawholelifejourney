...
class AssistantMessage(models.Model):
    ...
    # Quick reply buttons for interactive responses
    # Schema: [{"id": "yes", "label": "Yes", "action": "mark_medicine_taken", "params": {...}}, ...]
    ...
    is_proactive = models.BooleanField(
        default=False,
        help_text="Whether this message was proactively generated by the system"
    )

    # Track if quick reply was used
    quick_reply_used = models.CharField(
        max_length=50,
        blank=True,
        help_text="ID of the quick reply button that was clicked"
    )
