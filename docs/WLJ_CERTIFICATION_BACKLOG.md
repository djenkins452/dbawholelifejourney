...
| 4 | Medication | "when did I last TAKE X" | **LOW–MEDIUM (measured)** — weak pass; answered today's dose status, not last-taken date | Truth gap — no last-taken surface | ⚠️ weak pass | none |
