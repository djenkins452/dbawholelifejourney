...
| `WLJ_OPERATIONS_VISION.md` | Governing | Engineer | **The WLJ Operations subsystem** — Layer 1 truth domain; recovery classification (R0–R4), recovery lifecycle, maturity model (O0–O5), living 9-phase roadmap + status ledger. |
