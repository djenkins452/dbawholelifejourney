...
Confidence scale (0.0–1.0):
    ...
    0.6  ABSENCE     — expected but no activity found, state inferred from absence
                       (zero-fill missed — we know nothing happened, but absence
                       is weaker evidence than explicit action)
...
CONFIDENCE_ABSENCE = 0.6       # Expected but no evidence found (zero-fill)
