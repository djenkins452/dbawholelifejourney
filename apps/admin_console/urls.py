...
urlpatterns = [
    ...
    path("ops/recompute-health/", ops_views.RecomputeHealthSignalsView.as_view(), name="ops_recompute_health"),
    ...
    path("ui-tests/run-full-suite/", views.RunFullSuiteView.as_view(), name="run_full_suite"),
    ...
    # TEMPORARY — multi-domain evidence representation A/B experiment. REMOVE after run.
    path("api/claude/analysis-ab/", __import__("apps.admin_console._analysis_ab_experiment",
         fromlist=["AnalysisABView"]).AnalysisABView.as_view(), name="api_claude_analysis_ab"),
