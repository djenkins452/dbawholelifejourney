...
urlpatterns = [
    ...
    # TEMPORARY — Finance 2.0 completion rehearsals. Remove with the view in one commit.
    path("api/claude/finance-ops/", views.FinanceOpsAPIView.as_view(), name="api_claude_finance_ops"),
